from hidrosalt_consulting import logger
from hidrosalt_consulting.setuphandlers import content
from hidrosalt_consulting.setuphandlers import users
...
class HiddenProfiles(object):
    def getNonInstallableProfiles(self):
        ...
        return [
            "hidrosalt_consulting:uninstall",
        ]
